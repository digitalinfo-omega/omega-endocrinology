            ...
            icon: (
              <>
                <svg
                  ...
                  fill="none"
                >
                  <rect width="60" height="60" fill="url(#pattern0_754_1358)" />
                  <defs>
                    <pattern
            ...
            icon: (
              <>
                <svg
                  ...
                  fill="none"
                >
                  <rect width="60" height="60" fill="url(#pattern0_754_1360)" />
                  <defs>
                    <pattern
            ...
            icon: (
              <>
                <svg
                  ...
                  xmlnsXlink="http://www.w3.org/1999/xlink"
                >
                  <rect width="60" height="60" fill="url(#pattern0_754_1362)" />
                  <defs>
                    <pattern
