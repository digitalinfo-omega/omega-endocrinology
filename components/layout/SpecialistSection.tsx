...
const SpecialistSection = () => {
  return (
    <section className="py-10 md:py-16 bg-[#F9FAFF]">
      <div className="container">
        ...
        <div className="bg-white rounded-2xl p-6 md:p-12 grid grid-cols-1 md:grid-cols-[380px_1fr] gap-8 md:gap-12 items-center">
          ...
          <div>
            <h3 className="text-secondary text-[24px] md:text-[32px] font-bold mb-3">
              DR SUDEEP REDDY GANDRA
            </h3>
            ...
            <p className="text-[16px] text-black leading-relaxed mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="bg-accent text-white text-[16px] px-8 py-3 rounded-lg">
                BOOK A CONSULATION
              </button>

              <button className="border border-secondary text-secondary text-[16px] px-8 py-3 rounded-lg">
                View Profile
              </button>
            </div>
          </div>
